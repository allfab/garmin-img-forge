...
use mpforge_cli::config::GridConfig;
use mpforge_cli::pipeline::reader::{Feature, GeometryType, RTreeIndex};
use mpforge_cli::pipeline::tiler::TileProcessor;
...
fn test_assign_features_all_tiles_empty() {
    ...
    let tiles = vec![mpforge_cli::pipeline::tiler::TileBounds {
        col: 0,
        row: 0,
        min_lon: 10.0,
        min_lat: 10.0,
