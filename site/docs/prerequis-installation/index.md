...
|----------|---------|----------------|-------|
| **mpforge** (binaire statique) | v0.4.3 | [:material-download: tar.gz](https://github.com/allfab/garmin-img-forge/releases/download/mpforge-v0.4.3/mpforge-linux-amd64.tar.gz) · [:material-download: zip](https://github.com/allfab/garmin-img-forge/releases/download/mpforge-v0.4.3/mpforge-linux-amd64.zip) | Tuilage — inclut GDAL et ogr-polishmap |
| **imgforge** (binaire statique) | v0.5.0 | [:material-download: tar.gz](https://github.com/allfab/garmin-img-forge/releases/download/imgforge-v0.5.0/imgforge-linux-amd64.tar.gz) · [:material-download: zip](https://github.com/allfab/garmin-img-forge/releases/download/imgforge-v0.5.0/imgforge-linux-amd64.zip) | Compilation Garmin IMG |
