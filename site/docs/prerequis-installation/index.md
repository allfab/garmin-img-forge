...
|----------|---------|----------------|-------|
| **mpforge** (binaire statique) | v0.4.2 | [:material-download: tar.gz](https://forgejo.allfabox.fr/allfab/garmin-ign-bdtopo-map/releases/download/mpforge-v0.4.2/mpforge-linux-amd64.tar.gz) · [:material-download: zip](https://forgejo.allfabox.fr/allfab/garmin-ign-bdtopo-map/releases/download/mpforge-v0.4.2/mpforge-linux-amd64.zip) | Tuilage — inclut GDAL et ogr-polishmap |
| **imgforge** (binaire statique) | v0.4.3 | [:material-download: tar.gz](https://forgejo.allfabox.fr/allfab/garmin-ign-bdtopo-map/releases/download/imgforge-v0.4.3/imgforge-linux-amd64.tar.gz) · [:material-download: zip](https://forgejo.allfabox.fr/allfab/garmin-ign-bdtopo-map/releases/download/imgforge-v0.4.3/imgforge-linux-amd64.zip) | Compilation Garmin IMG |
