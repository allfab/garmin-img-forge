...
| `--packaging MODE` | Format d'emballage des sous-fichiers par tuile : `legacy` (6 fichiers FAT) ou `gmp` (1 `.GMP` Garmin NT). Voir [imgforge — Format d'emballage](../le-projet/imgforge.md#format-demballage---packaging). | `legacy` |
